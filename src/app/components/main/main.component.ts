...
export class MainComponent implements OnInit {
  ...
  localpublickeyserver;    //publicKey del servidor que esta en localstorage
  localcarteracifrada = [];   //id de monedas firmadas que las guardamos en local storage
  keyhex;  //clave que está en localstorage en hex y la cogemos
  keybuff; //imported key que es un Arraybuffer
  salt; //el salt que le pasamos al hacer el login
  passwordsacar;   //la password que introducire en el textbox para sacar dinero a tu cartera
  passwordpay;      //la password que introducire en el textbox para pagar a la tienda
  //////////////////////para secretsharing hemos cogido siempre la primera clave
